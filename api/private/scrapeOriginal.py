...
import os
import requests
# mindenhova beférkőzik ez a levesember. igazából engem is megvett kilóra, ez a projekt az ő megrendelésére készül szigorúan szabad piaci alapon.
...
def handleParagraph(paragraph):
    if "Jelölő szervezet:" in str(paragraph):
        return "party", [i.lower() for i in paragraph.findChildren("strong")[0].next_sibling.strip().split("-")]
    keys = {
